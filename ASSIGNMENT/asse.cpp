...
class custumer_name //enter customer detail
{
public:
    string n;
    void name()
...
public:
    ...
    void orde()
    {
        ...
        cout<<endl<<"                                    -----Menu-----";
        cout<<"\ n1) Pizzas\ n2) Burgers\ n3) Sandwich\ n4) Rolls \ n5) Biryani"<<endl;
...
public:
    int Quanitity()
    {
        cout<<"Please Enter quanitity:";    //show messages enter quanitity
        cin>>quanitity; //enter food quanitity
    }
    int Sicilianpizza()
    {
        return quanitity*80;  //total amount  of Bill
    }
    int Greekpizza()
    {
        return quanitity*95;
    ...
    int Margheritapizza()
    {
        return quanitity*135;
    }
    int beefburgers()
    {
        return quanitity*155;
    }
    int chickenburgers()
    {
    ...
    int HoneyWheatRolls()
    {
        return quanitity*145;
    }
    int EasyDinnerRolls()
    {
        return quanitity*160;
    }
    ...
    {
        if(choice==1)   //check witch main menu ex.1.pizza
        {
...
public:
    ...
    {
        cout<<endl<<"Your Order Will be delivered in 40 Minutes";   //your food deliverd time
